    ...
    <div className='pb-20 px-6 lg:px-16 text-[#111]'>
      ...
      <div>
        ...
        <p className='py-4 md:text-lg  text-[black]/80'>
          ...
          Discover inspirational stories, expert tips, innovative products, and
          a worldwide community—all in one place. Scan the code to get started.
        </p>
      ...
      <div className='py-12'>
        ...
        <div className='pb-12'>
          ...
          <p className='py-4 md:text-lg  text-[black]/80'>
            If you’re on the Nike App, you’re a Nike Member. You’ll get the best
            Nike has to offer—First Access to our latest drops before anyone
            else, Member-only products, plus special promotions and Member-only
            events.
          </p>
        </div>
      </div>
      ...
      <div className='pb-12'>
        ...
        <p className='py-4 md:text-lg  text-[black]/80'>
          Shop a store that’s tailored to you. Get product recommendations based
          on what you love, plus fast and secure checkout.
        </p>
      </div>
      <div className='pb-12'>
      ...
      <div className='pb-12'>
        ...
        <p className='py-4 md:text-lg  text-[black]/80'>
          From in-depth stories to training tips and style advice, there’s more
          sport to discover than ever before.
        </p>
      </div>
      <div className='pb-12'>
        <h3 className='text-3xl md:text-4xl pt-12 font-semibold'>
